...
sudo wget https://swift.org/builds/swift-3.0-release/ubuntu1404/swift-3.0-RELEASE/swift-3.0-RELEASE-ubuntu14.04.tar.gz \
  && sudo tar xzvf swift-3.0-RELEASE-ubuntu14.04.tar.gz \
  && sudo rm swift-3.0-RELEASE-ubuntu14.04.tar.gz

sudo export PATH=/root/swift-3.0-RELEASE-ubuntu14.04/usr/bin:$PATH
...
sudo rm /usr/bin/ld && ln -s /usr/bin/ld.gold /usr/bin/ld
